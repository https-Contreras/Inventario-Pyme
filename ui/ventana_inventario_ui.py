...
"}")
        ...
        self.btn_alfabeticamente.setIconSize(QtCore.QSize(40, 40))
        ...
        self.btn_mayoramenor.setIconSize(QtCore.QSize(40, 40))
        ...
        self.btn_menormayor.setIconSize(QtCore.QSize(40, 40))
        ...
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap("../models/restablecer.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btn_restablecer.setIcon(icon18)
        self.btn_restablecer.setIconSize(QtCore.QSize(40, 40))
...
"}")
        ...
        icon19 = QtGui.QIcon()
        icon19.addPixmap(QtGui.QPixmap("../models/exportar.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btn_exportar.setIcon(icon19)
        ...
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap("../models/agregar.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btn_agregar.setIcon(icon20)
        self.btn_agregar.setIconSize(QtCore.QSize(25, 25))
        ...
        icon21 = QtGui.QIcon()
        icon21.addPixmap(QtGui.QPixmap("../models/basura.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btn_editareliminar.setIcon(icon21)
        self.btn_editareliminar.setIconSize(QtCore.QSize(25, 25))
