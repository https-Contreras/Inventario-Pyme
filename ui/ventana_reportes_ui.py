# Form implementation generated from reading ui file 'ventana_reportes.ui'
#
...
"}")
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap("../models/filtrar.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btn_filtrar.setIcon(icon13)
...
"")
        ...
        self.frame_2 = QtWidgets.QFrame(parent=self.frame_barrafiltro)
        ...
        self.label_3.setPixmap(QtGui.QPixmap("../models/calendario.svg"))
        ...
        self.btn_antiguo_a_actual = QtWidgets.QPushButton(parent=self.frame_barrafiltro)
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap("../models/mayor_a_menor.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btn_antiguo_a_actual.setIcon(icon14)
        self.btn_antiguo_a_actual.setIconSize(QtCore.QSize(35, 35))
        self.btn_antiguo_a_actual.setObjectName("btn_antiguo_a_actual")
        self.verticalLayout_5.addWidget(self.btn_antiguo_a_actual)
        self.btn_actual_a_antiguo = QtWidgets.QPushButton(parent=self.frame_barrafiltro)
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap("../models/menor_a_mayor.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btn_actual_a_antiguo.setIcon(icon15)
        self.btn_actual_a_antiguo.setIconSize(QtCore.QSize(35, 35))
        self.btn_actual_a_antiguo.setObjectName("btn_actual_a_antiguo")
        self.verticalLayout_5.addWidget(self.btn_actual_a_antiguo)
        self.frame_3 = QtWidgets.QFrame(parent=self.frame_barrafiltro)
        ...
        self.label_6.setPixmap(QtGui.QPixmap("../models/stock.svg"))
        self.label_6.setScaledContents(True)
        self.label_6.setObjectName("label_6")
        self.horizontalLayout_7.addWidget(self.label_6)
        self.verticalLayout_5.addWidget(self.frame_3)
        self.btn_entradas_2 = QtWidgets.QPushButton(parent=self.frame_barrafiltro)
        self.btn_entradas_2.setIcon(icon6)
        self.btn_entradas_2.setIconSize(QtCore.QSize(30, 30))
        self.btn_entradas_2.setObjectName("btn_entradas_2")
        self.verticalLayout_5.addWidget(self.btn_entradas_2)
        self.btn_salidas_2 = QtWidgets.QPushButton(parent=self.frame_barrafiltro)
        self.btn_salidas_2.setIcon(icon7)
        self.btn_salidas_2.setIconSize(QtCore.QSize(30, 30))
        self.btn_salidas_2.setObjectName("btn_salidas_2")
        self.verticalLayout_5.addWidget(self.btn_salidas_2)
        spacerItem5 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.verticalLayout_5.addItem(spacerItem5)
        self.btn_restablecer = QtWidgets.QPushButton(parent=self.frame_barrafiltro)
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap("../models/restablecer.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btn_restablecer.setIcon(icon16)
        self.btn_restablecer.setIconSize(QtCore.QSize(30, 30))
        self.btn_restablecer.setObjectName("btn_restablecer")
        self.verticalLayout_5.addWidget(self.btn_restablecer)
...
"}")
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap("../models/exportar.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btn_exportar.setIcon(icon17)
        self.btn_exportar.setIconSize(QtCore.QSize(25, 25))
        self.btn_exportar.setObjectName("btn_exportar")
        self.horizontalLayout_4.addWidget(self.btn_exportar)
        self.btn_graficar = QtWidgets.QPushButton(parent=self.frame_exportar)
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap("../models/grafica.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btn_graficar.setIcon(icon18)
        self.btn_graficar.setIconSize(QtCore.QSize(25, 25))
        self.btn_graficar.setObjectName("btn_graficar")
        self.horizontalLayout_4.addWidget(self.btn_graficar)
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Ventana Reportes"))
        ...
        self.label_4.setText(_translate("Form", "Lista de movimientos"))
        self.label_2.setText(_translate("Form", "Por Fecha"))
        self.btn_antiguo_a_actual.setText(_translate("Form", "Mas antiguo al mas reciente"))
        self.btn_actual_a_antiguo.setText(_translate("Form", "Mas reciente al mas antiguo"))
        self.label_5.setText(_translate("Form", "Tipo Ent/Sal"))
        self.btn_entradas_2.setText(_translate("Form", "Entradas"))
        self.btn_salidas_2.setText(_translate("Form", "Salidas"))
        self.btn_restablecer.setText(_translate("Form", "Restablecer"))
        self.btn_exportar.setText(_translate("Form", "Exportar a txt"))
        self.btn_graficar.setText(_translate("Form", "Graficar datos"))
