...
"")
        ...
        self.btn_antiguo_a_actual.setIconSize(QtCore.QSize(30, 30))
        ...
        self.btn_actual_a_antiguo.setIconSize(QtCore.QSize(30, 30))
...
"}")
        ...
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap("../models/exportar.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btn_exportar.setIcon(icon16)
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap("../models/grafica.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btn_graficar.setIcon(icon17)
